...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user) {
    return next(new AppError('There is no useer with that email address', 401));
  }
  //Generate token
  ...
  const message = `Forgot your password? Submit a PACTH request with your password and passwordConfirm
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //if token has not expired, and there is user already, set the new password
